        ...
        <header className='bg-red-600'>
            <div className="container mx-auto flex justify-between">
                <nav className="flex">
                    ...
                    <NavLink to='/post' activeClassName="text-red-100 bg-red-700" className="inline-flex items-center py-3 px-3 my-6 rounded tex-red-200 hover:text-green-800">
                        Blog
                    </NavLink>
                    <NavLink to='/project' activeClassName="text-red-100 bg-red-700" className="inline-flex items-center py-3 px-3 my-6 rounded tex-red-200 hover:text-green-800">
                        Projects
                    </NavLink>
                    <NavLink to='/about' activeClassName="text-red-100 bg-red-700" className="inline-flex items-center py-3 px-3 my-6 rounded tex-red-200 hover:text-green-800">
                        About
                    </NavLink>
                </nav>
